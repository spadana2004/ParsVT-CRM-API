...
class RestfulApi {
    ...
    public function signInByLoginPassword($crmUrl, $userLogin, $userPassword)
    {
        ...
        $url = $this->crmUrl . 'modules/ParsVT/ws/index.php?module=Auth&login=' . $userLogin . '&password=' . $userPassword;
    ...
    public function signInByKey($crmUrl, $userAccessKey)
    {
        ...
        $url = $this->crmUrl . 'modules/ParsVT/ws/index.php?module=Auth&key=' . $userAccessKey;
    ...
    public function call($url_params, $a_params=array())
    {
        ...
        {
            $url = $this->crmUrl . "modules/ParsVT/ws/index.php?" . $url_params;
        }
        else
        {
            $url = $url_params;
